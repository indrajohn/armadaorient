...
<body>
    ...
    <!-- Google Map js -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAeYNEvxgFZciXhBKf-6cLX8S854zVqV4Y"></script>
    ...
    function init() {
        ...
        var latlng = new google.maps.LatLng(-7.532454, 110.850861);
        ...
        var marker = new google.maps.Marker({
            ...
            map: map,
            title: 'Ramble!',
            icon: 'assets/images/icons/map-2.png',

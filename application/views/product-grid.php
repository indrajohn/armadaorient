                                            ...
                                            <div class='fr__hover__info'>
                                                <ul class='product__action'>
                                                    ...
                                                    <form method='POST' action='addToCart'>
                                                        <input type='hidden' name='id_product' value='".$produk['id']."' id='id_product'/>
                            ...
                            <ul class="ht__cat__list">
                                <?php
                                    foreach ($data_kategori as $kategori) {
                                        ...
                                        // </form>";
                                        echo " <li class='active'><a href='product-grid?category_id=".$kategori['id']."&no=1')>".$kategori['nama']."</a></li>";
                                    }
                                ?>

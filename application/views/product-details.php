                ...
                <div class="row">
                        ...
                        <div class="htc__product__details__tab__content">
                            ...
                            <div class="product__big__images">
                                <div class="portfolio-full-image tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                                        <img src="upload/product/<?php echo $data->url_produk ?>" style="height:510px;width:677px;" alt="full-image">
                                    </div>
                            ...
                            <ul class="product__small__images" role="tablist">
                                <li role="presentation" class="pot-small-img active">
                                    ...
                                    <img src="upload/product/<?php echo $data->url_produk ?>" style="height:80px;width:106px;" alt="small-image">
                                    </a>
                                </li>
                    ...
                    <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                        <div class="ht__product__dtl">
                            ...
                            <ul class="pro__prize">
                                <li class="old__prize"><strike><?php echo Home::rupiah($data->harga_produk)?></strike></li>
                                <li><?php echo Home::rupiah($data->harga_produk -  ($data->harga_produk * ($data->discount/100)) )?></li>
                            </ul>
                            <p class="pro__info"><?php echo $data->produk_desk?></p>
                            <div class="ht__pro__desc">
                                <div class="sin__desc">
                                    <p><span>Availability:</span> <?php echo $data->stock >= 1 ? $data->stock . "pcs" : 'Out Of Stock'?></p>

                                </div>
                                <div class="sin__desc">
                                <form method="POST" action="addToCart">
                                    <input type="hidden" name="id_product" value="<?php echo $data->id ?>" id="id_product"/>
                                    <a href="#" style="background: #c43b68; padding:16px;color:#fff;border-radius: 25px;" class="addproduct"><i class="icon-handbag">Add To Cart</i></a>
                                </form>
                                </div>
                               ...
                               <!-- <div class="sin__desc product__share__link">
                                    ...
                                    <ul class="pro__share">
                                        ...
                                        <li><a href="#" target="_blank"><i class="icon-social-linkedin icons"></i></a>
                                        </li>

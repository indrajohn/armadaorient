								...
								<tbody>
									<?php
                                        if(sizeof($dataCart) == 0){
                                            echo "<tr scope='row'><td>Your Cart is Empty</td></tr>";
                                        }
                                        $price_all = 0;
                                        $count=0;
                                        $myObjt = array();
										...
										?>
									<tr scope="row">
										<td><img src='assets/images/product-2/cart-img/1.jpg'
												style='width:100px;height:100px;' alt='product img' /></td>
										<td><?php echo $cart['product_name'];  ?>
										</td>
										<?php
                                                        $price_per_piece = 0;
                                                        $price_per_piece = $cart['product_price'] - ($cart['product_price'] * ($cart['product_discount']/100));
                                                        $priceperpieceinIDR = $this->utility->rupiah($price_per_piece);
                                                        $price_total = $price_per_piece*$cart['product_total'];
                                                        $price_all = $price_all + $price_total;
                                                    ?>
										<td id='price'><?php echo $priceperpieceinIDR; ?></td>
										<td><input type='number' min="1" value='<?php echo $cart['product_total']?>'
												style="width:40px;" /></td>
								...
								<div class="htc__cart__total">
									...
									<div class="cart__desk__list">
										...
										<ul class="cart__price">
											<li class="cart_total">
												<?php echo "Rp. ".$this->utility->rupiah($price_all); ?></li>
											<li>Rp 0,00</li>
											<li>Rp 0,00</li>
										</ul>
									</div>
									<div class="cart__total">
										...
										<span
											class="order_total"><?php echo "Rp. ".$this->utility->rupiah($price_all); ?></span>
									</div>

                    ...
                    <div class="col-xs-12 col-lg-12">
                        <div class="htc__blog__details__wrap">
                            <div class="ht__bl__thumb">
                                <img src="<?php base_url()?>assets/images/blog/big-images/1.jpg" alt="blog images">
                            </div>
                            <div class="bl__dtl">
                                ...
                                <p>which of us ever undertakes laborious physical exercise, except to obtain some
                                ...
                                <blockquote>
                                    ...
                                    because those who do not know how to pursue pleasure ratinally encounter
                                    consequences that are.But I must explain to you how all this mistaken idea of
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="bl__img">
                                            <img src="<?php base_url()?>assets/images/blog/md-img/1.jpg"
                                                alt="blog images">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="bl__img">
                                            <img src="<?php base_url()?>assets/images/blog/md-img/2.jpg"
                                                alt="blog images">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ht__comment__content">
                                    ...
                                    <div class="comment">
                                        <div class="comment__thumb">
                                            <img src="<?php base_url()?>assets/images/comment/1.png"
                                                alt="comment images">
                                        </div>
                                    ...
                                    <div class="comment comment--reply">
                                        <div class="comment__thumb">
                                            <img src="<?php base_url()?>assets/images/comment/2.png"
                                                alt="comment images">
                                        </div>
                                        <div class="ht__comment__details">
                                            <div class="ht__comment__title">
                                    ...
                                    <div class="comment">
                                        <div class="comment__thumb">
                                            <img src="<?php base_url()?>assets/images/comment/3.png"
                                                alt="comment images">
                                        </div>
                                        <div class="ht__comment__details">
                                            <div class="ht__comment__title">
